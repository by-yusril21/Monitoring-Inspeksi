...
if (isset($_POST['delete_data'])) {
  ...
  $sql_delete = "DELETE FROM data_sensor WHERE sensor_relay1 = 'sensor'";
...
$sql = "SELECT * FROM data_sensor WHERE sensor_relay1 = 'sensor'";
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            ...
            <!-- Bagian ini untuk tombol hapus data -->
            <div class="col-lg-12">
              <div class="card-body">
                <form method="post" action="" class="d-flex">
                  <div class="mr-3">
                    <button type="submit" name="delete_data" class="btn btn-primary">Hapus Data Sensor</button>
                  </div>
                  <div>
                ...
                <div>
                  <p1><b>Hapus Data Sensor</b> : hanya menghapus data sensor</p1> <br> <p1><b>Reset Data</b> : Menghapus semua data sensor,relay dan ID di kembalikan ke 0</p1>
                </div>
              </div>
            </div>
          </div>
